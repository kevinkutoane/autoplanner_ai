...
class NotesScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    if (tagFilter != null) {
      notes = notes
          .where((n) => n.tags.any((t) => t.toLowerCase() == tagFilter.toLowerCase()))
          .toList();
    }
                ...
                child: notes.isEmpty
                    ...
                    : AnimationLimiter(
                        child: ListView(
                          ...
                          children: [
                            // Pinned section
                            if (pinned.isNotEmpty) ...[                              const SectionLabel(icon: Icons.push_pin_rounded, label: 'Pinned'),
                            ...
                            // Unpinned section
                            if (unpinned.isNotEmpty) ...[                              if (pinned.isNotEmpty)
                                const SectionLabel(icon: Icons.notes_rounded, label: 'Others'),
                              const SizedBox(height: 8),
        ...
        actions: [
          ...
          GradBtn(
            ...
            onTap: () {
              ...
              ref.read(noteControllerProvider.notifier).createNote(title: title);
              Navigator.pop(ctx);
